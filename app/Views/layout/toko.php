                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-lg-8 col-sm-6 col-xs-6">
                            <nav class="mainmenu__nav hidden-xs hidden-sm">
                                <ul class="main__menu">
                                    ...
                                    <li class="drop"><a href="<?php echo base_url('/shop');?>">Shop</a>
                                        <ul class="dropdown mega_dropdown">
                                            <!-- Start Single Mega MEnu -->
                                            <li><a class="mega__title" href="<?php echo base_url('/shop');?>">shop layout</a>
                                                <ul class="mega__item">
                                                    <li><a href="<?php echo base_url('/shop');?>">default shop</a></li>
                                                </ul>
                                            </li>
                                            <!-- End Single Mega MEnu -->
                                            <!-- Start Single Mega MEnu -->
                                            <li><a class="mega__title" href="<?php echo base_url('/shop');?>">product details layout</a>
                                                <ul class="mega__item">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-3">  
                            <ul class="menu-extra">
                                ...
                                <li><a href="<?php echo base_url('/login');?>"><span class="ti-user"></span></a></li>
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                            <div class="copyright__inner">
                                ...
                                <ul class="footer__menu">
                                    <li><a href="index.html">Home</a></li>
                                    <li><a href="<?php echo base_url('/shop');?>">Product</a></li>
                                    <li><a href="contact.html">Contact Us</a></li>
                                </ul>
                            </div>
                        </div>
