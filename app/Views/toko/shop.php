                        ...
                        <div class="product foo">
                            <div class="product__inner">
                                <div class="pro__thumb">
                                    <a href="#">
                                        <img src="<?= base_url($p['foto']) ?>" alt="product images">
                                    </a>
                                </div>
                                <div class="product__hover__info">
                                    <ul class="product__action">
                                        ...
                                        <li><a title="Wishlist" href="<?php echo base_url('/buyer/wishlist/'.$p['id']);?>"><span class="ti-heart"></span></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="product__details">
                                ...
                                <ul class="product__price">
                                    ...
                                    <li class="new__price"><?= $p['harga'] ?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
